...
console.log('desde admin appointment',props.appointment)
...
<template>
    <div class="bg-white p-5 space-y-3 rounded-lg">
        ...
        <p class="text-gray-500 font-black">
            ...
            Email: <span class="font-light">{{ appointment.user.email }} Horas</span>
        </p>
        <p class="text-gray-500 font-black">Servicios solicitados en la cita:</p>
